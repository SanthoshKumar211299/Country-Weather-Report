...
<div class="card-text text-center">Native Name: ${result[i].nativeName} </div>
<div class="card-text text-center">Population: ${result[i].population} </div>
...
`;
    ...
    buttons.forEach((btn, index) => {
      btn.addEventListener("click", () => {
        ...
        console.log(lat);
        console.log(lon);
        //weather api getting and updating the Lat, Lon, api hey to the api
